...
const Web3ModalProvider = ( props: ProviderProps ) => {
  const { createWeb3 } = web3Helper;
  ...
  return <Web3ModalContext.Provider value={wrapperValues}> { props.children } </Web3ModalContext.Provider>;
};
